...
class _AddBoardWidgetState extends State<AddBoardWidget> {
              ...
              content: Column(
                ...
                children: <Widget>[
                  ...
                  Row(
                    crossAxisAlignment: CrossAxisAlignment.center,
                    children: [
                      const Text('Board Dimensions', style: TextStyle(fontSize: 18)),
                      const SizedBox(width: 10),
                      Expanded(
                        child: DropdownButton<String>(
                ...
                TextButton(
                  ...
                  onPressed: () {
                    if (_nameController.text.isNotEmpty &&
                      ...
                      Navigator.of(context).pop();
                      _addBoard(parentContext, _nameController.text, _categoryController.text, rows, columns, _selectedLanguage!);
                    } else {
                      ScaffoldMessenger.of(context).showSnackBar(
                        const SnackBar(content: Text('Board Name, Dimensions, and Language are required')),
                      );
                    }
                  },
                ),
  ...
  Widget build(BuildContext context) {
    return ElevatedButton(
      ...
      child: const Text('Add Board', style: TextStyle(color: Colors.black, fontSize: 20)),
    );
  }
}
